...
import com.example.cache.sender.IMessageSender;
 ...
 * @param <V>
 */
public class MyCache<V> extends HashMap<String, V> implements CacheGroup, BeanNameAware, ApplicationContextAware {
