...
//@Component
public class ConstructorInitTest4Error {

    @Autowired
    public ConstructorInitTest4Error(TestObj1 testObj1){
        System.out.println("ConstructorInitTest3");
        System.out.println(testObj1);
    }

    @Autowired(required = false)
    public ConstructorInitTest4Error(TestObj1 testObj1, TestObj2 testObj2){
        System.out.println("ConstructorInitTest3");
        System.out.println(testObj1);
